...
export const ProjectsList = [
  ...
  },
  {
    ...
    image: Clonebook,
    shortDescription: "Pas très original mais très formateur. Je suis allé recopier pixel après pixel ce qui se fesait chez Facebook. J'ai également reproduit le comportement Back End avec une base de données et un hébergement des images dans le cloud. " ,
  ...
  },
  {
    ...
    code: "private",
    image: blog,
    shortDescription: "Site personnalisé pour un client. Galerie dynamique d'environ 500 images, réparties sur plusieurs pages et catégories. ",
  ...
  },
  {
    ...
    code: "https://github.com/HugoCalmels/react-social-network-redux",
    image: vv1,
    shortDescription: "Application pour mettre en relation des apprenants qui souhaitent se lancer au même moment. C'est focalisé sur les MOOC." ,
  ...
  },
  {
    ...
    code: "https://github.com/HugoCalmels/react-social-network-redux",
    image: ha1,
    shortDescription: "Application qui collecte les données de l'utilisateur selon des cycles (journalier, hebdomadaire, mensuel) pour les afficher sous forme de calendrier.",
  ...
  },
  {
    ...
    code: "https://github.com/HugoCalmels/react-social-network-redux",
    image: pv1,
    shortDescription: "Premier portfolio, pour voir à quel point j'ai pu progresser depuis 2022. Soyez indulgents je codais depuis 1 an à peine.",
  ...
  },
  {
    ...
    code: "https://github.com/HugoCalmels/react-social-network-redux",
    image: imageapp,
    shortDescription: "Première petite application React, reliée à une API publique d'images.",
  ...
  },
  {
    ...
    code: "https://github.com/HugoCalmels/react-social-network-redux",
    image: quiz,
    shortDescription: "Première petite application JavaScript Vanilla, reliée à une API publique de quiz.",
